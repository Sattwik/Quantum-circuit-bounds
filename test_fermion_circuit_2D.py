...
#     gaussian2D.adam_optimize(gaussian2D.dual_obj_no_channel, gaussian2D.dual_grad_no_channel,
#                            dual_vars_init_nc, dual_params,
#                            alpha, num_steps)
# noisy_bound_nc = -gaussian2D.dual_obj_no_channel(jnp.array(dual_opt_result_nc), dual_params)
...
#         gaussian2D.optimize(dual_vars_init_nc_direct, dual_params,
#                           gaussian2D.dual_obj_no_channel_direct_lambda, gaussian2D.dual_grad_no_channel_direct_lambda,
#                           num_iters = num_steps, bounds = bnds)
#     noisy_bound_nc_direct = -gaussian2D.dual_obj_no_channel_direct_lambda(jnp.array(dual_opt_result_nc_direct.x), dual_params)
#
# a_range = jnp.linspace(-4, 5, 1000)
# lmbda_range = jnp.log(1 + jnp.exp(a_range))
# a_range = jnp.reshape(a_range, (1000, 1))
# dual_grad_nc_array = vmap(gaussian2D.dual_grad_no_channel, in_axes = [0, None])(a_range, dual_params)
# dual_obj_nc_array = vmap(gaussian2D.dual_obj_no_channel, in_axes = [0, None])(a_range, dual_params)
#
...
# obj_init_fori = gaussian2D.dual_obj(dual_vars_init, dual_params)
...
# #     gaussian2D.adam_optimize(gaussian2D.dual_obj, gaussian2D.dual_grad,
# #                            dual_vars_init, dual_params,
# #                            alpha, num_steps)
# # noisy_bound_adam_p1 = -gaussian2D.dual_obj(jnp.array(dual_opt_result_adam), dual_params)
#
# #phase 2
# # alpha = 0.001
...
# #                            dual_vars_init, dual_params,
# #                            alpha, num_steps)
# # noisy_bound_adam_p2 = -gaussian2D.dual_obj(jnp.array(dual_opt_result_adam), dual_params)
#
# phase 1
...
# #
# # # phase 2
# # dual_vars_init_phase2 = jnp.array(dual_opt_result_phase1.x)
# # dual_obj_over_opti_phase2, dual_opt_result_phase2 = \
# #     gaussian2D.optimize(dual_vars_init_phase2, dual_params,
# #                       gaussian2D.dual_obj, gaussian2D.dual_grad,
# #                       num_iters = num_steps)
# # noisy_bound = -gaussian2D.dual_obj(jnp.array(dual_opt_result_phase2.x), dual_params)
# #
...
# # plt.show()
#
# # dual_obj_init = gaussian2D.dual_obj(dual_vars_init, dual_params)
# # dual_obj_log_init = gaussian2D.dual_obj_log(dual_vars_init, dual_params)
# #
# # dual_grad_init = gaussian2D.dual_grad(dual_vars_init, dual_params)
# # dual_grad_log_init = gaussian2D.dual_grad_log(dual_vars_init, dual_params)
# #
...
# #     gaussian2D.optimize(dual_vars_init, dual_params,
# #                       gaussian2D.dual_obj_log, gaussian2D.dual_grad_log,
# #                       num_iters = num_steps)
# # noisy_bound_log = -gaussian2D.dual_obj(jnp.array(dual_opt_result_log.x), dual_params)
# #
# # plt.plot(-dual_obj_over_opti_log)
# # plt.show()
#
...
# #     gaussian2D.optimize(dual_vars_init_direct, dual_params,
# #                       gaussian2D.dual_obj_direct_lambda, gaussian2D.dual_grad_direct_lambda,
# #                       num_iters = num_steps, bounds = bnds)
# # noisy_bound_direct = -gaussian2D.dual_obj_direct_lambda(jnp.array(dual_opt_result_direct.x), dual_params)
#
...
# #
# # noisy_bound_direct = -gaussian2D.dual_obj_direct_lambda(dual_vars_opt_result, dual_params)
#
