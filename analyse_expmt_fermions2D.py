...
# approx ratios vs N = 8,10 for p = 1%-20%, lambda bounds = 0
data_path = "./../vqa_data/1024/20221024-191318/"

# approx ratios vs N = 4-14 for p = 1%, lambda bounds = 0
data_path = "./../vqa_data/1018/20221018-175954/"

# approx ratios vs N = 12-18 for p = 5-20%, lambda bounds = 0
data_path = "./../vqa_data/0926/20220926-192512/"
...
#
#     mean_approx_noisy_sol = np.mean(approx_ratio_noisy_sol[i_N, :, :, 0], axis = 0)
#     std_approx_noisy_sol = np.std(approx_ratio_noisy_sol[i_N, :, :, 0], axis = 0)
#
...
#
#     mean_approx_noisy_bound_nc = np.mean(approx_ratio_noisy_bound_nc[i_N, :, :, 0], axis = 0)
#     std_approx_noisy_bound_nc = np.std(approx_ratio_noisy_bound_nc[i_N, :, :, 0], axis = 0)
#
