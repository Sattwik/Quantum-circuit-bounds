...
a_vars_init = np.zeros(p)
sigma_vars_init = np.ones(dual_obj.len_vars - p)
...
value, state = dual_jax.adam_external_dual_JAX(jnp.array(vars_init), dual_obj_jax, alpha = 0.1, num_steps = 100)
