...
ax.plot(theta_list/np.pi, noisy_bound_list, color = 'C1' ,label = "Circuit dual bound")
ax.plot(theta_list/np.pi, primal_list, color = 'C0', ls = '--', label = "Circuit output energy", lw = 1)
...
ax.plot(theta_list/np.pi, noisy_nc_list, label = "Entropic bound", ls = '--', color = 'k')
