...
# k_dual_list = [1, 5, 8, 10, 13, 15, 17, 20]
k_dual_list = [N]
...
for i_k, k_dual in enumerate(k_dual_list): 
    ...
    nb_nc_list.append(noisy_bound_nc)
    ...
    nb_list.append(noisy_bound)
    result_list.append(dual_opt_result_phase1)
    ...
    nb_purity_list.append(noisy_bound_purity)
    result_pur_list.append(dual_opt_result_purity)
